...
class Trainer:
    ...
    def run_single_process(self, task):
        ...
        :param task:
        """
        # build models, optm and load checkpoint
    ...
    def evaluate(self, task, test=False, tqdm_desc='Valid', max_batches=None):
        ...
        # give models a chance to do something with the outputs (and method defined)
        if test:
    ...
    def train(self):
        ...
        while True:
            ...
            # update training progress in trainer and models
